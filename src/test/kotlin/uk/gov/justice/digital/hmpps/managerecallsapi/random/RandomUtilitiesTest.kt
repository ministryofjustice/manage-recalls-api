  ...
  fun `can create a random fully populated Recall`() {
    ...
    assertThat(
      ...
      allOf(
        ...
        has(Recall::inCustodyAtBooking, present()),
        has(Recall::inCustodyAtAssessment, present()),
  ...
  fun `can create a random fully populated UpdateRecallRequest`() {
    ...
    assertThat(
      ...
      allOf(
        ...
        has(UpdateRecallRequest::inCustodyAtBooking, present()),
        has(UpdateRecallRequest::inCustodyAtAssessment, present()),
