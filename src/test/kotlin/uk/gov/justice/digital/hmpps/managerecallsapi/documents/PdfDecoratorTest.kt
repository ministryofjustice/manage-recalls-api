...
internal class PdfDecoratorTest {
  ...
  @Test
  fun `numberPages appends numeric 1 based page numbering to each page of input but skips first page`() {
    val inputBytes = ClassPathResource("/document/3_pages_unnumbered.pdf").file.readBytes()

    val actualReader = PdfReader(underTest.numberPages(inputBytes, 1))
    ...
    assertThat(actualReader.numberOfPages, equalTo(3))
    assertThat(inputExtractor.getTextFromPage(1), equalTo("Unnumbered page 1 of three."))
    assertThat(actualExtractor.getTextFromPage(1), equalTo("Unnumbered page 1 of three."))
    assertThat(inputExtractor.getTextFromPage(2), equalTo("Unnumbered page 2 of three."))
    assertThat(actualExtractor.getTextFromPage(2), equalTo("Unnumbered page 2 of three. 1"))
    assertThat(inputExtractor.getTextFromPage(3), equalTo("Unnumbered page 3 of three."))
    assertThat(actualExtractor.getTextFromPage(3), equalTo("Unnumbered page 3 of three. 2"))
  }
}
