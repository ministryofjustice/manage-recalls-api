...
class GetRecallComponentTest : ComponentTestBase() {
  ...
  fun `get a fully populated FIXED term recall`() {
    ...
    authenticatedClient.get("/recalls/$recallId")
      ...
      .jsonPath("$.authorisingAssistantChiefOfficer").isEqualTo(fullyPopulatedRecall.probationInfo!!.authorisingAssistantChiefOfficer.value)
      ...
      .jsonPath("$.legalRepresentativeInfo.fullName").isEqualTo(fullyPopulatedRecall.legalRepresentativeInfo!!.legalRepresentativeName.value)
      .jsonPath("$.legalRepresentativeInfo.email").isEqualTo(fullyPopulatedRecall.legalRepresentativeInfo!!.legalRepresentativeEmail.value)
      .jsonPath("$.legalRepresentativeInfo.phoneNumber").isEqualTo(fullyPopulatedRecall.legalRepresentativeInfo!!.legalRepresentativePhoneNumber.value)
      ...
      .jsonPath("$.probationOfficerPhoneNumber").isEqualTo(fullyPopulatedRecall.probationInfo!!.probationOfficerPhoneNumber.value)
